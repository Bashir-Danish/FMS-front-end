...
function validate() {
    ...
    if (props.modelValue && props.inputType === "password") {
        ...
        if (re.test(props.modelValue)) {
            ...
            message.value = "رمز عبور باید شامل حرف بزرگ،حرف کوچک کاراکتر ویژه باشد";
            mColor.value = false;
        }
    }
...
<template>
    <div class="inputBox">
        ...
        <input :type="inputType" :value="modelValue" :required="isRequired" :placeholder="props.placeholder"
